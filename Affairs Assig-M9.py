...
# =============================================================================
# Que 1 :- Prepare a prediction model for probability of extra marital affair.
# =============================================================================

affairs = pd.read_csv("H://DATA SCIENCE//Modules//Module 9 Logistic Regression//Datasets//Affairs.csv//Affairs.csv",index_col = 0)
affairs.columns
affairs.info()
affairs.isnull().sum()
